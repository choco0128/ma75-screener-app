...
st.set_page_config(
    page_title="25日線初押し・75日線押し目・三角保ち合いブレイク",
    layout="wide"
)
...
st.title("25日線初押し・75日線押し目・三角保ち合いブレイク スクリーニングアプリ")

st.write("出来高急増後の25日線初押し・75日線押し目・三角保ち合いブレイク初動をタブで切り替えて探せます。")
...
tab25, tab75, tab_triangle = st.tabs(["25日線初押し", "75日線押し目", "三角保ち合いブレイク"])
