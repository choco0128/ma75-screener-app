...
st.title("25日線初押し・75日線押し目・200日線押し目・三角保ち合い・モメンタム・材料判定 スクリーニングアプリ")

st.write("出来高急増後の25日線初押し・75日線押し目・200日線押し目・三角保ち合いブレイク初動・モメンタム初動/強勢継続・場中/引け後の適時開示PDF材料判定に加えて、値上がり率Top50理由分析をタブで切り替えて探せます。")
...
with st.sidebar:
    ...
    use_ma200_filter = st.checkbox("25日線・75日線・三角：200日線より上の銘柄に絞る", value=False)
...
with st.expander("このアプリの見方"):
    st.write(
        ...
        200日線押し目は、長期上昇トレンドの中で200日線付近まで大きく押した銘柄を探す用途です。
...
tab25, tab75, tab200, tab_triangle, tab_momentum, tab_tdnet_pdf, tab_top_gainers = st.tabs(["25日線初押し", "75日線押し目", "200日線押し目", "三角保ち合いブレイク", "モメンタム", "適時開示PDF材料判定", "値上がり率Top50理由分析"])
